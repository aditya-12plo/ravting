...
<div class="container-fluid display-page" id="display-post-category" >
 <!-- @create Modal--->
        ...
        <template slot="header" ><h4>Add New Warehouse</h4></template>
        <template slot="body" >
            <form method="POST" action="" @submit.prevent="submitBooks()">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control border-input" placeholder="Company Name" v-model="forms.company_name"  type="text" required>
                        <span class="label label-danger" v-for="error of errorNya['company_name']">
                        {{ error }}
                    </span>
                    </div>
                    <!-- form Group -->
                    <div class="form-group">
                        <label for="company_initial">Company Initial</label>
                        <input class="form-control border-input" placeholder="Company Initial" v-model="forms.company_initial"  type="text" maxlength="25" required>
                        <span class="label label-danger" v-for="error of errorNya['company_initial']">
                        {{ error }}
                    </span>
                    </div>
                    ...
                    <div class="form-group">
						...
						<textarea class="form-control border-input" placeholder="Company Address" v-model="forms.company_address"  required></textarea>
                        <span class="label label-danger" v-for="error of errorNya['company_address']">
                        {{ error }}
                    </span>
                    </div>
...
<!-- @view --->
        ...
        <template slot="header" ><h4>View Warehouse Detail</h4></template>
        <template slot="body" >
                <div class="modal-body">
                    ...
                    <!-- form Group -->
                    <div class="form-group">
                        <label for="company_initial">Company Initial :  {{forms.company_initial}}</label>
                      
                    </div>

                    <!-- form Group -->
                    <div class="form-group">
                        <label for="company_address">Company Address :  {{forms.company_address}}</label>
...
<!-- @update --->
        ...
        <template slot="header" ><h4>Edit Warehouse Detail</h4></template>
        <template slot="body" >
            ...
            <form method="POST" action="" @submit.prevent="updateItem()">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="company_initial">Company Initial</label>
                        <input class="form-control border-input" placeholder="Company Name" maxlength="25" v-model="forms.company_initial"  type="text" required>
                        <span class="label label-danger" v-for="error of errorNya['company_initial']">
                        {{ error }}
                    </span>
                    </div>
 ...
 <!-- @delete --->
        ...
        <template slot="header" ><h4>Delete Warehouse</h4></template>
        <template slot="body" >
...
<div style="overflow-x:auto;">
  ...
  <tr>
    ...
    <tr>
      ...
      <td colspan="3"><input type="text" v-model="filterText" class="form-control" @keyup.enter="doFilter" placeholder="company name / Initial"></td>
    </tr>
     <tr>
    ...
    <tr>
      <td colspan="4"><button class="btn btn-success" @click.prevent="doFilter">Go</button>
		  ...
		  <button class="btn btn-danger"  @click="sumSelectedItems()">
            Delete All
        </button></td>
    </tr>
</table>
...
export default {
  ...
  data () {
    ...
    errors: new Errors() ,
    forms:new CrudForm({index:'',  id:'' , company_name:'' , company_initial:'' , company_address:'' ,created_at:''}) ,
  ...
  methods: {
   ...
   var check = confirm("Are you sure you want to delete this row?");  
                ...
                //console.log(join_selected_values);
                    ...
                    axios.delete('/kevler/kevlerCompanyDeleteAll/'+ this.join_selected_values)
                    .then(response => {
                this.errorNya = '';
  ...
  fetchIt(){
                this.loading = true;
                axios.get('/kevler/GetUserAccess/master/w').then((response) => {
                    this.loading = false
                }).catch(error => {
  ...
  resetOptions() {
    ...
    submitBooks() {
            axios.post('/kevler/kevlerCompany', this.forms)
                    .then(response => {
                this.errorNya = '';
                this.resetFilter();
   ...
   updateItem() {
            axios.put('/kevler/kevlerCompany/'+ this.forms.id , this.forms)
                    .then(response => {
                this.errorNya = '';
                this.resetFilter();
            ...
            destroyItem(kode){
                axios.delete('/kevler/kevlerCompany/'+ kode)
                    .then(response => {
                this.errorNya = '';
                this.resetFilter();
...
onLoading() {
    ...
    onLoadingError() {
                this.loading = true;
                axios.get('/kevler/kevlerCompany').then((response) => {
