      ...
      <tr>
        ...
        <td align="right" colspan="2"><h4><b>{{formatNumberRupiah(TotalCapexB2S())}}</b></h4></td>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" @click="modal.set('reject', true)">Perbaiki Ke GM UBIS</button>
...
<!-- @direktur -->
        ...
        <template slot="header" ><h4 align="center">Pesan Project Approval Direktur</h4></template>
        <template slot="body" >
...
export default {
  ...
  option: {
    ...
    modal:new CrudModal({view:false,simulasi:false, reject:false, direktur:false, approve:false,  repair:false, message:false}),
     berhasilNya: [],
	 simulasiNya: [],
simulasiNyaKedua: [],
     errorNya: [],
        ...
        showTime(kode,pesan) {
          this.$refs.toast.showToast(pesan, {
            ...
            SubmitData(){
			  ...
			  RepairItem() {
var masuk ={id:this.forms.id,message:this.message,level:'GENERAL MANAGER UBIS',statusnya:'REPAIR UBIS - GENERAL MANAGER'};
