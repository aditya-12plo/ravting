...
<!-- for header  -->            
  ...
  <table class="table">
      ...
      <tr>
        <td><h5 align="left"><b>Lokasi</b></h5></td>
        <td colspan="5"><h5 align="left"><b>{{PesanData.header.sitename}}</b></h5></td>
      </tr>
      <tr>
        <td><h5 align="left"><b>Area</b></h5></td>
        <td colspan="5"><h5 align="left"><b>{{PesanData.header.area}}</b></h5></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="6"><h4 align="center"><b>IMPLEMENTASI PEKERJAAN STANDAR</b></h4></td>
      </tr>
      <tr>
       ...
       <tr v-for="item of PesanData.standart">
        ...
        <td>{{formatNumberRupiah(formatNumber(item.total))}}</td>
         ...
         <tr>
        <td align="center" colspan="4"><b>Total Biaya Pekerjaan Standar</b></td>
        <td colspan="1"><b>{{formatNumberRupiah(formatNumber(total(this.PesanData.standart)))}}</b></td>
      </tr>
	  <tr>
        <td colspan="6"> <div style="height: 50px; overflow:hidden;"></div></td>
      </tr>
	  ...
	  <tr>
        <td colspan="6"><h4 align="center"><b>IMPLEMENTASI PEKERJAAN TAMBAHAN</b></h4></td>
      </tr>
      <tr>
        <td colspan="1"><center><b>ITEM PEKERJAAN</b></center></td>
        <td><center><b>SAT</b></center></td>
       ...
       <tr v-for="item of PesanData.additional">
        ...
        <td>{{formatNumberRupiah(formatNumber(item.total))}}</td>
         ...
         <tr>
        <td align="center" colspan="4"><b>Total Biaya Pekerjaan Tambahan</b></td>
        <td colspan="1"><b>{{formatNumberRupiah(formatNumber(total(this.PesanData.additional)))}}</b></td>
      </tr>
	  <tr>
        <td colspan="6"> <div style="height: 50px; overflow:hidden;"></div></td>
      </tr>
	  ...
	  <tr>
        <td colspan="6"><h4 align="center"><b>IMPLEMENTASI PENGURANGAN BIAYA PEKERJAAN</b></h4></td>
      </tr>
      <tr>
        <td colspan="1"><center><b>ITEM PEKERJAAN</b></center></td>
        <td><center><b>SAT</b></center></td>
       ...
       <tr v-for="item of PesanData.reduction">
        ...
        <td>{{formatNumberRupiah(formatNumber(item.total))}}</td>
         ...
         <tr>
        <td align="center" colspan="4"><b>Total Pengurangan Biaya Pekerjaan</b></td>
        <td colspan="1"><b>{{formatNumberRupiah(formatNumber(total(this.PesanData.reduction)))}}</b></td>
      </tr>
	  <tr>
        <td colspan="6"> <div style="height: 50px; overflow:hidden;"></div></td>
      </tr>
    <tr>
        ...
        <td colspan="1"><b>{{formatNumberRupiah(formatNumber((total(this.PesanData.standart) + total(this.PesanData.additional)) - total(this.PesanData.reduction)))}}</b></td>
      </tr>
...
<div style="overflow-x:auto;">
  ...
  <div v-show="loading"><i class="fa fa-spinner fa-spin"></i> Loading Data</div>
    <vuetable ref="vuetable"
      api-url="/tenant/GetProjectProgress"
      :fields="fields"
      pagination-path=""
...
onLoading() {
    ...
    onLoadingError() {
                this.loading = true;
                axios.get('/tenant/GetProjectProgress').then((response) => {
                    this.loading = false
                }).catch(error => {
        if (! _.isEmpty(error.response)) {
                    if (error.response.status = 500) {
