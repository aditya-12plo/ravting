...
<div class="container-fluid display-page" id="display-post-category" >
        ...
        <template slot="header"><h4 align="center">BILL OF QUANTITY ACTUAL</h4></template>
        <template slot="body" >
...
<input type="text" v-model="forms.projectid" class="form-control" placeholder="Project ID" required>
 ...
 <money v-model="forms.budget" class="form-control border-input" v-bind="money"></money>                          
<span class="label label-danger" v-for="error of errorNya['budget']">
                        {{ error }}
                    </span>                       
                    </div>
 ...
 <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control border-input" placeholder="Proc" v-model="forms.proc"  type="text" required>
                        <span class="label label-danger" v-for="error of errorNya['proc']">
                        {{ error }}
                    </span>
 </div>
 </div>
 ...
 <div class="col-sm-6">
                    ...
                    <!-- form Group -->
                    <div class="form-group">
                        <label for="Ubis">Ubis</label>
                        <input class="form-control border-input" placeholder="Ubis" v-model="forms.ubis"  type="text" required>
                        <span class="label label-danger" v-for="error of errorNya['ubis']">
                        {{ error }}
                    </span>
 </div>
 </div>
...
<div class="col-sm-12">
   ...
   <div class="col-sm-4">
                   <!-- form Group -->
                    <div class="form-group">
                        <label for="kode_tower_depan">Type Depan Tower</label>
                        <input class="form-control border-input" placeholder="Type Depan Tower" v-model="forms.kode_tower_depan"  type="text" required>
                        <span class="label label-danger" v-for="error of errorNya['kode_tower_depan']">
                        {{ error }}
                    </span>
        </div>  
...
<span class="label label-danger" v-for="error of errorNya['tower']">
           ...
           <div class="col-sm-4">
                   <!-- form Group -->
                    <div class="form-group">
                        <label for="kode_tower_belakang">Jenis Belakang Tower</label>
                        <input class="form-control border-input" placeholder="Jenis Belakang Tower" v-model="forms.kode_tower_belakang"  type="text" required>
                        <span class="label label-danger" v-for="error of errorNya['kode_tower_belakang']">
                        {{ error }}
                    </span>
        </div>  
      </div>  
...
<select class="form-control border-input" v-model="forms.infratype" required >
 ...
 <div class="col-sm-6">
  <!-- form Group -->
                    <div class="form-group">
                        <label for="towerprovider">Tower Provider</label>
<input class="form-control border-input" placeholder="Tower Provider" v-model="forms.towerprovider"  type="text" required>
          <span class="label label-danger" v-for="error of errorNya['towerprovider']">
                        {{ error }}
                    </span>
                    </div>
 </div>
...
<input class="form-control border-input" placeholder="Cluster" v-model="forms.cluster"  type="text" required>
 ...
 <div class="col-sm-6">
                    ...
                    <!-- form Group -->
                    <div class="form-group">
                        <label for="projectid">Site ID</label>
                        <input class="form-control border-input" placeholder="Site ID" v-model="forms.siteid"  type="text" required>
                        <span class="label label-danger" v-for="error of errorNya['siteid']">
                        {{ error }}
                    </span>
 </div>
 </div>
...
<input class="form-control border-input" placeholder="Provinsi" v-model="forms.provinsi"  type="text" required>
  <span class="label label-danger" v-for="error of errorNya['provinsi']">
                        {{ error }}
                    </span>
                    </div>
 </div>
...
<input class="form-control border-input" placeholder="Kabupaten / Kota" v-model="forms.kabupaten"  type="text" required>
 ...
 <div class="col-sm-6">
                    ...
                    <!-- form Group -->
                    <div class="form-group">
                        <label for="Kordinate">Kordinate : <a :href="'http://www.google.com/maps/place/'+this.forms.latituted+','+this.forms.longitude" target="_blank">Cek Lokasi</a></label></div>
     <div class="col-sm-12"> 
     <div class="col-sm-6">

                    <!-- form Group -->
                    <div class="form-group">
                        <label for="projectid">Longitude</label>
                        <input class="form-control border-input" placeholder="Longitude" v-model="forms.longitude" v-on:keypress="isNumber()" required>
  ...
  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control border-input" placeholder="Latitude" v-model="forms.latituted" v-on:keypress="isNumber()" required>
  ...
  <div class="col-sm-6">
                    <!-- form Group -->
                    <div class="form-group">
                        <label for="Upload">Dokumen Upload :  </label>
...
<span class="label label-success" v-if="berhasilNya">
 ...
 <table class="table">
      ...
      <tr>
        ...
        <td align="center">LS</td>
        <td align="center"><money v-model="forms.qty_lahan" class="form-control border-input" placeholder="Sewa Lahan (Include PPh)" v-bind="tower"></money></td>
        <td align="center">{{this.forms.qty_lahan}}</td>
        <td align="right"><money v-model="forms.lahan" class="form-control border-input" placeholder="Sewa Lahan (Include PPh)" v-bind="money"></money>                          
<span class="label label-danger" v-for="error of errorNya['lahan']">
                        {{ error }}
                    </span></td>
        <td align="right">{{formatNumberRupiah(forms.qty_lahan*forms.lahan)}}</td>
      </tr>
      ...
      <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right"><money v-model="forms.biayatower" class="form-control border-input" placeholder="Sewa Lahan (11 tahun include PPh)" v-bind="money"></money></td>
        <td align="right">{{formatNumberRupiah(forms.biayatower)}}</td>
      </tr>
      ...
      <tr>
        ...
        <td align="right">{{formatNumberRupiah(forms.cme)}}</td>
      </tr>
      ...
      <tr>
        ...
        <td align="right">{{formatNumberRupiah(forms.pln)}}</td>
      </tr>
      ...
      <tr>
        ...
        <td align="right">{{formatNumberRupiah(forms.addcme)}}</td>
      </tr>
      ...
      <tr>
        ...
        <td align="right">{{formatNumberRupiah(forms.addpln)}}</td>
      </tr>
      ...
      <tr>
        ...
        <td align="right">{{formatNumberRupiah(forms.addtransport)}}</td>
      </tr>
      ...
      <tr>
        <td align="center" colspan="6"><h4><b>Total Pekerjaan Standart :</b></h4></td>
        <td align="right" colspan="2"><h4><b>{{formatNumberRupiah(forms.sis+forms.sitac+forms.imb+forms.imb_jasa+forms.lahan+forms.biayatower+forms.cme+forms.pln)}}</b></h4></td>
      </tr>
      ...
      <tr>
        <td align="center" colspan="6"><h4><b>Total Pekerjaan Non Standart :</b></h4></td>
        <td align="right" colspan="2"><h4><b>{{formatNumberRupiah(forms.addcme+forms.addpln+forms.addtransport)}}</b></h4></td>
      </tr>

      
      <tr>
        <td align="left" colspan="6"><div style="height: 15px; overflow:hidden;"></div></td>
      </tr>

      <tr>
        <td align="center" colspan="6"><h4><b>Total CAPEX :</b></h4></td>
        <td align="right" colspan="2"><h4><b>{{formatNumberRupiah(forms.sis+forms.sitac+forms.imb+forms.imb_jasa+forms.lahan+forms.biayatower+forms.cme+forms.pln+forms.addcme+forms.addpln+forms.addtransport)}}</b></h4></td>
      </tr>
...
<span class="label label-danger" v-for="error of errorNya['lahan']">
      ...
      <tr>
        ...
        <td align="right"><money v-model="dataStandard.biayatower" class="form-control border-input" placeholder="Biaya Tower" v-bind="money"></money></td>
      ...
      <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right"><money v-model="dataStandard.erection_tower" class="form-control border-input" placeholder="Biaya Tower" v-bind="money"></money></td>
        <td align="right"><money v-bind:value="dataStandard.erection_tower" class="form-control border-input" placeholder="Biaya Tower" v-bind="money" disabled></money></td>
      </tr>
      ...
      <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right"><money v-model="dataStandard.transportasi" class="form-control border-input" placeholder="Biaya Transportasi" v-bind="money"></money></td>
        <td align="right"><money v-bind:value="dataStandard.transportasi" class="form-control border-input" placeholder="Biaya Transportasi" v-bind="money" disabled></money></td>
      </tr>
      ...
      <tr>
        ...
        <td align="right"><money v-model="dataStandard.pondasi" class="form-control border-input" placeholder="Biaya Pondasi Greenfiled" v-bind="money"></money></td>
        <td align="right"><money v-bind:value="dataStandard.pondasi_greenfiled*dataStandard.pondasi" class="form-control border-input" placeholder="Biaya Pondasi Greenfiled" v-bind="money" disabled></money></td>
      </tr>
...
<td>
 ...
 <td>
  <money v-bind:value="roww.qty * roww.harga" class="form-control border-input" placeholder="Total" v-bind="money" disabled></money> 
      ...
      <tr>
        <td align="center" colspan="6"><h4><b>Total Pekerjaan Standart :</b></h4></td>
        <td align="right" colspan="2"><h4><b>{{formatNumberRupiah(this.forms.sis+this.forms.sitac+this.forms.imb+this.forms.imb_jasa+(this.forms.qty_lahan*this.forms.lahan)+(this.dataStandard.tonase*this.dataStandard.biayatower)+this.dataStandard.erection_tower+this.dataStandard.transportasi+(this.dataStandard.pondasi_greenfiled*this.dataStandard.pondasi)+this.dataStandard.bts_outdoor+this.dataStandard.me+this.dataStandard.fy+this.dataStandard.pln_connect)}}</b></h4></td>
      </tr>
      ...
      <tr>
        <td align="center" colspan="6"><h4><b>Total CAPEX :</b></h4></td>
        <td align="right" colspan="2"><h4><b>{{formatNumberRupiah(this.forms.sis+this.forms.sitac+this.forms.imb+this.forms.imb_jasa+(this.forms.qty_lahan*this.forms.lahan)+(this.dataStandard.tonase*this.dataStandard.biayatower)+this.dataStandard.erection_tower+this.dataStandard.transportasi+(this.dataStandard.pondasi_greenfiled*this.dataStandard.pondasi)+this.dataStandard.bts_outdoor+this.dataStandard.me+this.dataStandard.fy+this.dataStandard.pln_connect+total(this.tambahan))}}</b></h4></td>
      </tr>
      ...
      <tr>
        <td align="left" colspan="8"><div style="height: 15px; overflow:hidden;"></div></td>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" @click="modal.set('prpo', false) & modal.set('view', false) & modal.set('simulasi', false)" >Close</button>
                    <button type="button" class="btn btn-default" @click="modal.set('prpo', true)">No PR & PO</button>
...
<!-- @nomor pr & po -->
        <modal  v-if="modal.get('prpo')" @close="modal.set('prpo', false)">
        <template slot="header"><h4 align="center">NO PO & PO {{forms.projectid}}</h4></template>
        <template slot="body" >
<form method="POST" action="" @submit.prevent="PesanPRPO()" enctype="multipart/form-data">
  <div class="modal-body">
        <div class="col-sm-12"> 
 ...
 <table class="table">
            ...
            <tr>
        <td align="left" colspan="3"><b><button type="button" class="button btn-primary" @click="addRowPRPO">+ Input No PR & PO </button></b></td>
      </tr>
...
<td> </td>
 ...
 <td align="center">No PO</td>
       ...
       <tr v-for="(roww,index) in this.noprpo">
 <td><button type="button" class="button btn-danger" @click="removeRowPRPO(index)"><i class="glyphicon glyphicon-remove"></i></button></td>
 <td align="left"><b>{{index+1}}</b></td>
 <td>
 <input type="text" v-model="roww.workjobs" maxlength="200" class="form-control" placeholder="Nama Pekerjaan" autofocus required></td>
 <td><input type="text" v-model="roww.nopr" maxlength="100" class="form-control" placeholder="No PR" required></td>
 <td><input type="text" v-model="roww.po" maxlength="100" class="form-control" placeholder="No PO"  required></td>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" @click="modal.set('prpo', false)" >Close</button>
					<button type="submit" class="btn btn-primary">Submit</button>
                </div>
                </form>
        </template>
...
<!-- @approveprpo PR & PO-->
        <modal  v-if="modal.get('approveprpo')" @close="modal.set('approveprpo', false)">
        <template slot="header" ><h4 align="center">Kirim Pesan Project Perbaikan No PR & PO</h4></template>
        <template slot="body" >

            <form method="POST" action="" @submit.prevent="SubmitDataPRPO()">
                <div class="modal-body">
...
<div class="col-sm-12" v-else>
 <!-- form Group -->
  ...
  <textarea v-model="message" class="form-control" rows="5" id="message" placeholder="Pesan" required></textarea>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" @click="modal.set('approveprpo', false)" >Close</button>
...
<!-- @direktur --->
        <modal  v-if="modal.get('direktur')" @close="modal.set('direktur', false)">
        <template slot="header" ><h4 align="center">Kirim Pesan Project Persetujuan Direktur</h4></template>
        <template slot="body" >

            <form method="POST" action="" @submit.prevent="DirekturItem()">
                <div class="modal-body">
...
<span class="label label-danger" v-for="error of errorNya">
 ...
 <span class="label label-danger" v-for="error of errorNya['datamasuk']">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" @click="modal.set('direktur', false)" >Close</button>
                    <button type="submit" class="btn btn-primary">Kirim</button>
                </div>
            </form>
        </template>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <vuetable ref="vuetable"
      api-url="/karyawan/GetAllProject"
      :fields="fields"
      pagination-path=""
...
export default {
  ...
  option: {
    ...
    selectedtower: '',
    pesannya:[],
    forms:new CrudForm({index:'',  id:'',filename:'' ,projectimplementationid:'' ,no_doc:'', tinggitower:'' , proc:'' ,  ubis:'' , projectid:'' , sitename:'', siteid:'' , area:'', regional:'', cluster:'', kode_tower_depan:'' ,  tower:''  ,  kode_tower_belakang:'' , longitude:'' , latituted:'' , towerprovider:''  , infratype:'' , budget:'' ,  sis:'' ,  sitac:'' ,  imb:'' ,   imb_jasa:'' ,  qty_lahan:'' ,  lahan:'' ,  biayatower:'' ,  cme:'' ,   pln:'' ,   addtransport:'' ,  addpln:'' ,  addcme:'' , provinsi:''  , kabupaten:''  , mitra:'',towerimplementation:'',mitraimplementation :'' ,clusterimplementation:'', budget:'',status:'',created_at:''}) ,
    modal:new CrudModal({approveprpo:false,prpo:false,view:false,simulasi:false, reject:false, approve:false,  direktur:false,  repair:false, message:false}),
     berhasilNya: [],
     simulasiNya: [],
simulasiNyaKedua: [],
     errorNya: [],
...
axios.get('/karyawan/GetDetailStandartImplementationMA/'+this.forms.regional+'/'+this.forms.clusterimplementation+'/'+this.forms.towerimplementation).then((response) => {
  ...
  addRowPRPO: function(){
     this.noprpo.push({workjobs:"",nopr:"",po:""});
    },
    removeRowPRPO: function(row){
    //console.log(row);
    this.noprpo.splice(row,1)
    },
  addRow: function(){
...
fetchIt(){
this.isLoading = true;
                axios.get('/karyawan/GetProfileAdminstrator').then((response) => {
  ...
  PesanPRPO(){
            axios.get('/karyawan/GetMessageNya/'+this.id).then((response) => {
                this.pesannya=response.data;
                 this.message = '';
                 this.modal.set('approveprpo', true); 
                }).catch(error => {
                if (! _.isEmpty(error.response)) {
                    if (error.response.status = 422) {
                       this.$router.push('/server-error');
...
var masuk ={
  ...
  budget:this.forms.budget,
  status:this.forms.status,
  proc:this.forms.proc,
  ubis:this.forms.ubis,
  kode_tower_depan:this.forms.kode_tower_depan,
  tower:this.forms.tower,
  kode_tower_belakang:this.forms.kode_tower_belakang,
 longitude:this.forms.longitude,
 latituted:this.forms.latituted,
 infratype:this.forms.infratype,
 towerprovider:this.forms.towerprovider,
 provinsi:this.forms.provinsi,
 kabupaten:this.forms.kabupaten,
 cluster:this.forms.cluster,
 regional:this.forms.regional,
 area:this.forms.area,
 siteid:this.forms.siteid,
 ...
 message:this.message};
   ...
   axios.post('/karyawan/ApprovalProjectRevisi', masuk)
                    .then(response => {
...
if(response.data.success)
{
				  ...
				  this.isLoading = false;
				   this.message = '';
                this.resetFilter();
				this.modal.set('approveprpo', false);
                 this.modal.set('prpo', false);
                 this.submitted = this.showTime('success',response.data.success);
}
if(response.data.nodata)
{
              ...
              RepairItem() {
var masuk ={id:this.forms.id,message:this.message,level:this.levelnya,statusnya:'REPAIR UBIS - GENERAL MANAGER'};
...
if(response.data.success)
{
            ...
            this.isLoading = true;
 axios.get('/karyawan/GetProjectDetailNya/'+item.id+'/'+item.projectimplementationid+'/'+item.regional+'/'+item.area).then((response) => {
                ...
                this.noprpo = response.data.noprpo;
             ...
             SimulasiData(){
                ...
                {
                var ttl = this.forms.sis+this.forms.sitac+this.forms.imb+this.forms.imb_jasa+this.forms.lahan+this.forms.biayatower+this.forms.cme+this.forms.pln+this.forms.addcme+this.forms.addpln+this.forms.addtransport;
                var rglbudgetNya = (this.simulasiNya.regional.budgetNya+this.forms.budget)/(this.simulasiNya.regional.total+1);
                var rglcapexNya = (this.simulasiNya.regional.capexNya+ttl)/(this.simulasiNya.regional.total+1);
                var arebudgetNya = (this.simulasiNya.area.budgetNya+this.forms.budget)/(this.simulasiNya.area.total+1);
                var arecapexNya = (this.simulasiNya.area.capexNya+ttl)/(this.simulasiNya.area.total+1);
                var nslbudgetNya = (this.simulasiNya.nasional.budgetNya+this.forms.budget)/(this.simulasiNya.nasional.total+1);
                var nslcapexNya = (this.simulasiNya.nasional.capexNya+ttl)/(this.simulasiNya.nasional.total+1);
                ...
                {
                var ttl = (this.forms.sis+this.forms.sitac+this.forms.imb+this.forms.imb_jasa+this.forms.lahan+(this.dataStandard.tonase*this.dataStandard.biayatower)+this.dataStandard.erection_tower+this.dataStandard.transportasi+(this.dataStandard.pondasi_greenfiled*this.dataStandard.pondasi)+this.dataStandard.bts_outdoor+this.dataStandard.me+this.dataStandard.fy+this.dataStandard.pln_connect+this.total(this.tambahan));
                var rglbudgetNya = (this.simulasiNya.regional.budgetNya+this.forms.budget)/(this.simulasiNya.regional.total+1);
                var rglcapexNya = (this.simulasiNya.regional.capexNya+ttl)/(this.simulasiNya.regional.total+1);
                var arebudgetNya = (this.simulasiNya.area.budgetNya+this.forms.budget)/(this.simulasiNya.area.total+1);
                var arecapexNya = (this.simulasiNya.area.capexNya+ttl)/(this.simulasiNya.area.total+1);
