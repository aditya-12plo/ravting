...
<div class="container-fluid display-page" id="display-post-category" >
 <!-- @create Modal--->
        ...
        <template slot="header" ><h4>Add New Company</h4></template>
        <template slot="body" >
...
<!-- @view --->
        ...
        <template slot="header" ><h4>View Company Detail</h4></template>
        <template slot="body" >
                <div class="modal-body">
...
<!-- @update --->
        ...
        <template slot="header" ><h4>Edit Company Detail</h4></template>
        <template slot="body" >
 ...
 <!-- @delete --->
        ...
        <template slot="header" ><h4>Delete Company</h4></template>
        <template slot="body" >
...
export default {
  ...
  fetchIt(){
                this.loading = true;
                axios.get('/kevler/GetUserAccess/sub/cp1').then((response) => {
                    this.loading = false
                }).catch(error => {
