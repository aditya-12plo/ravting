<template>
 ...
 <vue-toast ref='toast'></vue-toast>
	  <p><h3 align="center"><b>AVERAGE CAPEX UNTAPPED - TAHUN {{this.$route.params.tahun}} </b></h3></p>
    </section>
...
<!-- @view --->
 ...
 <div class="col-sm-6">
	 ...
	 <div class="col-sm-6">				
                    ...
                    <!-- form Group -->
                    <div class="form-group">
                        <label for="budget">Plafon Project :  {{ formatNumberRupiah(forms.budget) }}</label>
                    </div>
 ...
 <div class="col-sm-6">
                    ...
                    <!-- form Group -->
                    <div class="form-group">
                        <label for="pono">Mitra Implementasi :  {{forms.clusterimplementation}}</label>
                    </div>
 ...
 <table class="table">
	  ...
	  <tr>
        ...
        <td align="center">LS</td>
        <td align="center">{{forms.qty_lahan}}</td>
        <td align="center">{{forms.qty_lahan}}</td>
        <td align="right">{{formatNumberRupiah(forms.lahan)}}</td>
 ...
 <table class="table">
	 ...
	 <tr>
	  ...
	  <tr>
        ...
        <td align="center">{{this.dataStandard.tonase}}</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.biayatower)}}</td>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.erection_tower)}}</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.erection_tower)}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.transportasi)}}</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.transportasi)}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">{{this.dataStandard.pondasi_greenfiled}}</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.pondasi)}}</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.pondasi_greenfiled*dataStandard.pondasi)}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.bts_outdoor)}}</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.bts_outdoor)}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.me)}}</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.me)}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.fy)}}</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.fy)}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.pln_connect)}}</td>
        <td align="right">{{formatNumberRupiah(this.dataStandard.pln_connect)}}</td>
      </tr>
 ...
 <td align="left"><b>{{roww.pekerjaan}}</b></td>
 <td align="center">{{roww.satuan}}</td>
 <td align="center">{{roww.qty}}</td>
 <td align="center">{{roww.qty}}</td>
<td align="right">{{formatNumberRupiah(roww.harga)}}</td>
<td align="right">{{formatNumberRupiah(roww.qty * roww.harga)}}</td>
      ...
      <tr>
        ...
        <td align="right" colspan="2"><h4><b>{{formatNumberRupiah(TotalCapexB2S())}}</b></h4></td>
                ...
                <div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" @click.prevent="print()">Print</button>
                </div>	
        </template>
        </modal>
...
<!-- @message --->
        ...
        <template slot="header" ><h4>Komunikasi Project</h4></template>
        <template slot="body" >
                <div class="modal-body">
 ...
 <!-- form Group -->
   ...
   <section class="content">
	...
	<table class="table table-bordered" style="overflow-x:auto;">
      <tr>
        <td colspan="2"><h1 align="center"><b>PROJECT DATA</b></h1></td>
      </tr>
      <tr>
        <td align="left"><b>ORDER</b></td>
		<td align="center" v-if="!this.JumlahData.ordernya"><b>0</b></td>
        <td align="center" v-else><b>{{this.JumlahData.ordernya}}</b></td>
      </tr>
      <tr>
        <td align="left"><b>PROSES APPROVAL</b></td>
		<td align="center" v-if="!this.JumlahData.prog"><b>0</b></td>
        <td align="center" v-else><b>{{this.JumlahData.prog}}</b></td>
      </tr>
      <tr>
        <td align="left"><b>DROP</b></td>
		<td align="center" v-if="!this.PesanData.tableB2s.canc"><b>0</b></td>
        <td align="center" v-else><b>{{this.JumlahData.canc}}</b></td>
      </tr>
      <tr>
        <td align="left"><b>APPROVED</b></td>
		<td align="center" v-if="!this.JumlahData.fin"><b>0</b></td>
        <td align="center" v-else><b>{{this.JumlahData.fin}}</b></td>
...
<div class="col-sm-12">	
	...
	<div class="col-sm-4">				
<div class="small">
<p><h5 align="center"><b>CAPEX NASIONAL</b></h5></p>
    <line-placapb2s :height="300" :data="this.placapb2s"></line-placapb2s>
  </div>
</div>
...
<p><h5 align="center"><b>CAPEX AREA</b></h5></p>
    <line-placapb2sarea :height="300" :data="this.placapb2sarea"></line-placapb2sarea>
  </div>
</div>
...
<p><h5 align="center"><b>CAPEX REGIONAL</b></h5></p>
    <line-placapunp :height="350" :data="this.placapunp"></line-placapunp>
  </div>
</div>
...
<div style="overflow-x:auto;">
  ...
  <tr>
    ...
    <tr>
      ...
      <td colspan="3"><input type="text" v-model="filterText" class="form-control" @keyup.enter="doFilter" placeholder="Projectid / Cluster"></td>
    </tr>
     <tr>
    ...
    <vuetable ref="vuetable"
      api-url="/karyawan/GetProjectFinalAllUNTAPPED"
      :fields="fields"
      pagination-path=""
      :per-page="perPage"
      :css="css.table"
...
Vue.component("line-placapb2sarea", {
    ...
    data () {
      return {
        datacollection: {
          ...
          labels: this.data.listareacapex ,
        datasets: [
          {
		   label: 'CAPEX',
          borderColor: '#05CBE1',
  ...
  props: ["data"],
    data () {
      return {
        datacollection: {
          //Data to be represented on x-axis
          labels: this.data.listregionalcapex ,
        datasets: [
          {
		   label: 'CAPEX',
          borderColor: '#05CBE1',
...
Vue.component("line-placapb2s", {
  ...
  data () {
      return {
        datacollection: {
          //Data to be represented on x-axis
          labels: ['CAPEX NASIONAL ('+this.data.jumlah+') ('+this.formatGrafikNumberRupiah(this.data.capex)+')'],
        datasets: [
          {
		   label: 'CAPEX',
          borderColor: '#05CBE1',
...
export default {
  ...
  data () {
    ...
    errors: new Errors() ,
	PesanData:[],
    forms:new CrudForm({index:'',  id:'',projectimplementationid:'' ,no_doc:'', tinggitower:'' , proc:'' ,  ubis:'' , projectid:'' , sitename:'', siteid:'' , area:'', regional:'', cluster:'', kode_tower_depan:'' ,  tower:''  ,  kode_tower_belakang:'' , longitude:'' , latituted:'' , towerprovider:''  , infratype:'' , budget:'' ,  sis:'' ,  sitac:'' ,  imb:''  , imb_jasa:'' ,  qty_lahan:'' ,  lahan:'' ,  biayatower:'' ,  cme:'' ,   pln:'' ,   addtransport:'' ,  addpln:'' ,  addcme:'' , provinsi:''  , kabupaten:''  , mitra:'',towerimplementation:'',mitraimplementation :'' ,clusterimplementation:'', budget:'',created_at:''}) ,
    modal:new CrudModal({view:false  , delete:false , message:false}),
     errorNya: [],
...
fetchIt(){
this.isLoading = true; 
                axios.get('/karyawan/DataGrafikAVGuNtp?tahun='+this.$route.params.tahun).then((response) => {
                    this.PesanData = response.data;
                    this.JumlahData = response.data.tableB2s;
                    this.placapb2s = response.data.placapb2s;
                    //this.placapunp = {regional:['aaaa','bbbbbb'],capex:['45300000','3423432']};
                    this.placapb2sarea = {listareacapex:response.data.listareacapex,area:response.data.area,capex:response.data.capexarea};
                    this.placapunp = {listregionalcapex:response.data.listregionalcapex,regional:response.data.regional,capex:response.data.capexregional};
...
var masuk = {palanya:this.forms,standard:this.dataStandard,additional:this.tambahan,pesan:this.approved};		
 ...
 axios.get('/karyawan/GetProjectDetailProses/'+item.id+'/'+item.projectimplementationid+'/'+item.regional+'/'+item.area).then((response) => {
  ...
  return total.reduce(function(total, num){ return total + num }, 0);
   ...
   CheckMessage() {
			axios.get('/karyawan/GetMessageNya/'+this.formsDatas.id).then((response) => {
  ...
  symbol: " M",precision: 0,format: "%v %s"})
    ...
    onCellClicked (data, field, event) {
      ...
      this.$refs.vuetable.toggleDetailRow(data.id)
            ...
            destroyItem(kode){
                axios.delete('/karyawan/DeleteProjectReject/'+ kode)
                    .then(response => {
                this.errorNya = '';
                this.resetFilter();
...
onLoading() {
  ...
  events: {
    'filter-set' (filterText,startTime,endtime) {
      this.moreParams = {
        tahun: this.$route.params.tahun, filter: filterText,min: startTime, max: endtime
      }
      Vue.nextTick(() => this.$refs.vuetable.refresh() )
    },
    'filter-reset' () {
      this.moreParams = {tahun: this.$route.params.tahun}
      Vue.nextTick(() => this.$refs.vuetable.refresh() )
    }
  },
 created: function() {
