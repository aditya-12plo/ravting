   ...
   <table class="table">
      ...
      <tr>
       ...
       <tr v-for="item of PesanData.standart">
        <td colspan="1">{{item.workitem}} - {{item.status}}</td>
      ...
      <tr>
        <td colspan="6"><h4 align="center"><b>BIAYA PEKERJAAN TAMBAHAN</b></h4></td>
      </tr>
      <tr>
        <td colspan="1"><center><b>ITEM PEKERJAAN</b></center></td>
        <td><center><b>SAT</b></center></td>
       ...
       <tr v-for="item of PesanData.additional">
        ...
        <td>{{formatNumberRupiah(formatNumber(item.total))}}</td>
         ...
         <tr>
        <td colspan="5"><center><b>Total Biaya Pekerjaan Tambahan</b></center></td>
      ...
      <tr>
        <td colspan="6"><h4 align="center"><b>BIAYA PENGURANGAN PEKERJAAN</b></h4></td>
      </tr>
      <tr>
        <td colspan="1"><center><b>ITEM PEKERJAAN</b></center></td>
        <td><center><b>SAT</b></center></td>
       ...
       <tr v-for="item of PesanData.reduction">
        ...
        <td>{{formatNumberRupiah(formatNumber(item.total))}}</td>
         ...
         <tr>
        <td colspan="5"><center><b>Total Biaya Pengurangan Pekerjaan</b></center></td>
      ...
      <tr>
        <td colspan="6"> <div style="height: 50px; overflow:hidden;">
         ...
         <tr>
        <td colspan="5"><center><b>Total Biaya Pekerjaan Reduction</b></center></td>
...
<div style="overflow-x:auto;">
  ...
  <tr>
    ...
    <vuetable ref="vuetable"
      api-url="/karyawan/GetProjectReject"
      :fields="fields"
      pagination-path=""
      :per-page="perPage"
      :css="css.table"
...
onLoading() {
    ...
    onLoadingError() {
                this.loading = true;
                axios.get('karyawan/GetProjectReject').then((response) => {
