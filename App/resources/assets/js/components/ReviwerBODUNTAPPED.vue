<template>
 ...
 <vue-toast ref='toast'></vue-toast>
      <h1 align="center">
       List Approval Project UNTAPPED
      </h1>
    </section>
      ...
      <tr>
        ...
        <td align="right" colspan="2"><h4><b>{{formatNumberRupiah(TotalCapexB2S())}}</b></h4></td>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" @click="modal.set('reject', true)">DROP</button>
...
<!-- @repair -->
        ...
        <template slot="header" ><h4 align="center">Alasan Project Harus Di Drop</h4></template>
        <template slot="body" >
...
export default {
  ...
  option: {
    ...
    modal:new CrudModal({approvemasal:false,simulasiB2S:false,view:false,simulasi:false, reject:false, approve:false,  repair:false, message:false}),
     berhasilNya: [],
	 simulasiNya: [],
simulasiNyaKedua: [],
     errorNya: [],
...
fetchIt(){
this.isLoading = true;
                axios.get('/karyawan/GetProfileBOD').then((response) => {
        ...
        showTime(kode,pesan) {
          this.$refs.toast.showToast(pesan, {
            ...
            SubmitData(){
			  ...
			  RepairItem() {
var masuk ={id:this.forms.id,message:this.message,level:'CANCEL',statusnya:'CANCEL'};
