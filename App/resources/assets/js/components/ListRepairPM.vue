...
<span class="label label-danger" v-for="error of errorNya['lahan']">
	  ...
	  <tr>
        ...
        <td align="right" colspan="2"><h4><b>{{formatNumberRupiah(forms.sis+forms.sitac+forms.imb+forms.lahan+forms.biayatower+forms.cme+forms.pln)}}</b></h4></td>
      </tr>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <vuetable ref="vuetable"
      api-url="/karyawan/GetProjectRepairAreaPM"
      :fields="fields"
      pagination-path=""
...
onLoading() {
    ...
    onLoadingError() {
                this.isLoading = true;
                axios.get('/karyawan/GetProjectRepairAreaPM').then((response) => {
                    this.isLoading = false
                }).catch(error => {
        if (! _.isEmpty(error.response)) {
