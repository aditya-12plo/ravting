<template>
 ...
 <vue-toast ref='toast'></vue-toast>
      <h1 align="center">
       List Approval Project Tower B2S
      </h1>
    </section>
...
<div style="overflow-x:auto;">
  <table>
    ...
    <vuetable ref="vuetable"
      api-url="/karyawan/GetProjectApprovalEGMUB2S"
      :fields="fields"
      pagination-path=""
...
this.masalKode='';	
  this.isLoading = true;
   ...
   else
   {
                ...
                //console.log(ttl);  			
var masuk = {data:ttl,infratype:'B2S'};		
...
onLoading() {
    ...
    onLoadingError() {
                this.isLoading = true;
                axios.get('/karyawan/GetProjectApprovalEGMUB2S').then((response) => {
                    this.isLoading = false
                }).catch(error => {
        if (! _.isEmpty(error.response)) {
