...
<!-- @view-->
 ...
 <table class="table">
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{this.dataStandard.erection_tower}}</td>
        <td align="right">{{this.dataStandard.erection_tower}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{this.dataStandard.transportasi}}</td>
        <td align="right">{{this.dataStandard.transportasi}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">{{this.dataStandard.pondasi_greenfiled}}</td>
        <td align="right">{{this.dataStandard.pondasi}}</td>
        <td align="right">{{this.dataStandard.pondasi_greenfiled*dataStandard.pondasi}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{this.dataStandard.bts_outdoor}}</td>
        <td align="right">{{this.dataStandard.bts_outdoor}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{this.dataStandard.me}}</td>
        <td align="right">{{this.dataStandard.me}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{this.dataStandard.fy}}</td>
        <td align="right">{{this.dataStandard.fy}}</td>
      </tr>
	  ...
	  <tr>
        ...
        <td align="center">1</td>
        <td align="center">1</td>
        <td align="right">{{this.dataStandard.pln_connect}}</td>
        <td align="right">{{this.dataStandard.pln_connect}}</td>
      </tr>
...
<div style="overflow-x:auto;">
  ...
  <tr>
    ...
    <vuetable ref="vuetable"
      api-url="/karyawan/GetProjectRejectMA"
      :fields="fields"
      pagination-path=""
      :per-page="perPage"
      :css="css.table"
...
onLoading() {
    ...
    onLoadingError() {
                this.isLoading = true;
                axios.get('/karyawan/GetProjectRejectMA').then((response) => {
                    this.dataNya = response.data;
                    this.isLoading = false;
                }).catch(error => {
				if (! _.isEmpty(error.response)) {
