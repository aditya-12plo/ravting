...
<span class="label label-danger" v-for="error of errorNya['lahan']">
	  ...
	  <tr>
        ...
        <td align="right"><money v-bind:value="this.dataStandard.pondasi_greenfiled*this.dataStandard.pondasi" class="form-control border-input" v-bind="money" disabled></money></td>
      </tr>
...
<!-- @repair -->
        ...
        <template slot="header" ><h4 align="center">Pesan Project Harus Approval Ulang</h4></template>
        <template slot="body" >
...
<div style="overflow-x:auto;">
  <table>
    ...
    <vuetable ref="vuetable"
      api-url="/karyawan/GetProjectRepair"
      :fields="fields"
      pagination-path=""
...
fetchIt(){
this.isLoading = true;
                axios.get('/karyawan/GetProfileUbisReviewerM').then((response) => {
...
mitra:this.forms.mitra,
 ...
 levelnya:'GENERAL MANAGER UBIS',
 statusnya:'UBIS - GENERAL MANAGER'};
