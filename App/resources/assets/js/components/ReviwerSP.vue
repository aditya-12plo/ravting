...
<span class="label label-danger" v-for="error of errorNya['lahan']">
      ...
      <tr v-if="this.levelnya==='DIRECTOR'">
        <td align="left" colspan="8"><h4><b>NOTES : * Project ini sudah mendapat Approval BOD Terkait</b></h4></td>
      </tr>
      ...
      <tr v-if="this.levelnya==='DIRECTOR'">
        <td align="left" colspan="8"><h4><b>NOTES : * Project ini sudah mendapat Approval BOD Terkait</b></h4></td>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" @click="modal.set('reject', true)"><div  v-if="this.levelnya==='GENERAL MANAGER AREA'">Perbaiki Ke AREA</div><div v-else>Perbaiki Ke UBIS</div></button>
        ...
        showTime(kode,pesan) {
          this.$refs.toast.showToast(pesan, {
            ...
            SubmitData(){
			  ...
			  RepairItem() {
			  if(this.levelnya === 'GENERAL MANAGER AREA')
			  {
			  var lvl = 'MANAGER AREA';
			  }
			  else
			  {
			   var lvl = 'MANAGER UBIS';
			  }
var masuk ={id:this.forms.id,message:this.message,level:lvl,statusnya:'REPAIR'};
